...
public class part4 : MonoBehaviour {
    ...
    {
        if (collision.gameObject.tag == "player1" && P1rocket.GetComponent<P1rocket>().part4 == false)
        {
            print("p1 got 3");
        ...
        if (collision.gameObject.tag == "player2" && P2rocket.GetComponent<P2rocket>().part4 == false)
        {
            print("p2 got 3");
